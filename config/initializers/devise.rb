...
Devise.setup do |config|
  ...
  # config.secret_key =
  #   'efc89f1dd582fc0c565aab68bf4256c2a4fddae3eb3d37b3ccdebbb75f85c
  #    7c95fb21b9bc133949f73af7e2aaff43937bec7b2d33a97c43192df45780445d160'

  config.secret_key =
    '1b3bc2f4ceda5ddf5bf1afcedb0f8aadfc0d4fbda052ea534d623536
    10419be259402859c7fef159f91beeda176ab363d9e0691a0cf4aa4209ec4596b9352933'
  ...
  # If using other algorithms, it sets how many times you
  ...
  # of stretches (e.g. a value of 20 is already extremely
  # slow: approx. 60 seconds for 1 calculation).
  config.stretches = Rails.env.test? ? 1 : 11

  # Set up a pepper to generate the hashed password.
  # config.pepper =
  #  '72cd8a46eaa21a2a0236739eb934cde2cc9a02ef3a2ff98899d2020b780a5
  #   b7953a815976e2ee30dfaba7d01a92bd7376c172be726249737b8c989c0178f8e1e'
  ...
  # (then you should set stretches to 10,
  ...
  # and this engine is mountable, there are some extra configurations to be
  # taken into account.
