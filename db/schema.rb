...
# Instead of editing this file, please use the migrations feature of Active
#   Record to incrementally modify your database, and then regenerate this
#   schema definition.
#
...
ActiveRecord::Schema.define(version: 20_180_308_220_026) do
  ...
  create_table 'reports', force: :cascade do |t|
    ...
    t.string 'month', default: '0', null: false
    t.integer 'year', default: 0, null: false
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.integer 'month_numb'
  end
end
...
ActiveRecord::Schema.define(version: 20_180_308_220_026) do
  create_table 'roles', force: :cascade do |t|
    ...
    t.index %w[resource_type resource_id],
            name: 'index_roles_on_resource_type_and_resource_id'
  end
